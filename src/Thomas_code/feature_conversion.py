...
def convert_discharge_disposition_to_numbers(df):
    """
    ...
    df['discharge_disposition_multiple'] = df['discharge_disposition_name'].copy().replace({
        'Home or Self Care': 5,
        'Group Home': 5,
        'Home with Equipment or O2': 5,
        'Home with Outpatient Services': 5,
    ...
    df['discharge_disposition_binary'] = df['discharge_disposition_name'].copy().replace({
        'Home or Self Care': 1,
        'Group Home': 1,
    ...
    df['discharge_disposition_three'] = df['discharge_disposition_name'].copy().replace({
        'Home or Self Care': 2,
        'Group Home': 2,
